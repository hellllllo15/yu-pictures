...
/** addPicture POST /api/picture/add */
export async function addPictureUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.addPictureUsingPOSTParams,
  body: {},
  file?: File,
  ...
  return request<API.BaseResponseBoolean_>('/api/picture/add', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** crawlOriginalUrls GET /api/picture/crawl/urls */
export async function crawlOriginalUrlsUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.crawlOriginalUrlsUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListString_>('/api/picture/crawl/urls', {
    method: 'GET',
    params: {
      ...params,
    },
